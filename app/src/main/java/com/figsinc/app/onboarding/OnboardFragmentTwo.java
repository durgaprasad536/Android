...
public class OnboardFragmentTwo extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView textView = (TextView) getActivity(). findViewById(R.id.tvHeaderTwo);
        Spannable word = new SpannableString(getResources().getString(R.string.onboardtwo_learn));

        word.setSpan(new ForegroundColorSpan(Color.WHITE), 0, word.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
        textView.setText(word);
        textView.append(" ");

        Spannable wordTwo = new SpannableString(getResources().getString(R.string.onboardingTwo));
