 ...
 * @author Rajesh K
 */
public class CapitalStructureListViewBarChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headersList.add("Debt_Equity");
        headersList.add("Debt_Assets");
        headersList.add("FCF_Equity");
        headersList.add("LT_Debt_Capital");

        listHeadersList.add("Debt Equity");
        listHeadersList.add("Debt Assets");
        listHeadersList.add("Debt to Capital");
        listHeadersList.add("Long Term Debt To Equity");
    ...
    private class ChartDataAdapter extends ArrayAdapter<BarData> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // to use for it
            MyMarkerView mv = new MyMarkerView(CapitalStructureListViewBarChartActivity.this, R.layout.custom_marker_view);
           ...
           // System.out.println(" 999999999======>>>> " + data.getEntryCount());
    ...
    private void network() {
        try {
            ...
            final RequestQueue requestQueue = Volley.newRequestQueue(CapitalStructureListViewBarChartActivity.this);
            String url = Constants.stocksFundamentalInformationCapitalStructure + tickerExchange;
           ...
           // System.out.println(" **********  " + FigsApplication.getAuthToken());
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(CapitalStructureListViewBarChartActivity.this, "\"That didn't work!\"", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
    ...
    private void setFooterIcons() {
        ...
        textAnalyze.setTextColor(ContextCompat.getColor(CapitalStructureListViewBarChartActivity.this, R.color.cobalt));
