 ...
 * @author Rajesh K
 */
public class ProfitabilityListViewBarChartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       /* getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
        ...
        headersList.add("Gross_Margin");
        headersList.add("ROC");
        headersList.add("Net_Margin");
        headersList.add("ROA");

        listHeadersList.add("Gross Margin (%)");
        listHeadersList.add("Return on Capital");
        listHeadersList.add("Net Margin (%)");
        listHeadersList.add("Return on Assets");
    ...
    private class ChartDataAdapter extends ArrayAdapter<BarData> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // to use for it
            MyMarkerView mv = new MyMarkerView(ProfitabilityListViewBarChartActivity.this, R.layout.custom_marker_view);
    ...
    private void network() {
        try {
            ...
            final RequestQueue requestQueue = Volley.newRequestQueue(ProfitabilityListViewBarChartActivity.this);
            String url = Constants.stocksFundamentalInformationProfitability + tickerExchange;
           ...
           // System.out.println(" **********  " + FigsApplication.getAuthToken());
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ProfitabilityListViewBarChartActivity.this, "\"That didn't work!\"", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
    ...
    private void setFooterIcons() {
        ...
        textAnalyze.setTextColor(ContextCompat.getColor(ProfitabilityListViewBarChartActivity.this, R.color.cobalt));
