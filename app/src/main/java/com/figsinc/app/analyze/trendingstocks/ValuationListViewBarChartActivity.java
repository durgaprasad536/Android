 ...
 * @author Rajesh K
 */
public class ValuationListViewBarChartActivity extends AppCompatActivity {
    ...
    private final ArrayList<String> webServicesHeadersList =new ArrayList<>();
    private final ArrayList<String> listHeadersList =new ArrayList<>();
    public static final String KEY_TICKER_EXCHANGE="KEY_TICKER_EXCHANGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      /*  getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
        ...
        webServicesHeadersList.add("EV_EBITDA");
        webServicesHeadersList.add("PE_Ratio");
        webServicesHeadersList.add("Dividend_Yield");
        webServicesHeadersList.add("Price_Book_Ratio");

        listHeadersList.add("EV/EBITDA");
        listHeadersList.add("Price Earnings");
        listHeadersList.add("Dividend Yield (%)");
        listHeadersList.add("Price/Book");
    ...
    private class ChartDataAdapter extends ArrayAdapter<BarData> {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            // to use for it
            MyMarkerView mv = new MyMarkerView(ValuationListViewBarChartActivity.this, R.layout.custom_marker_view);
    ...
    private BarData generateData(int cnt) {
       ...
       String header= webServicesHeadersList.get(cnt);

        BarDataSet d = new BarDataSet(entries, /*header*/"");
    ...
    private void network() {
        try {
            ...
            final RequestQueue requestQueue = Volley.newRequestQueue(ValuationListViewBarChartActivity.this);
            String url = Constants.stocksFundamentalInformationValuation + tickerExchange;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                ...
                public void onErrorResponse(VolleyError error) {
                    Toast.makeText(ValuationListViewBarChartActivity.this, "\"That didn't work!\"", Toast.LENGTH_SHORT).show();
                }
            }) {
                @Override
    ...
    private void showJSON(String json) {
        StocksBarChartDataParse pj = new StocksBarChartDataParse(json, webServicesHeadersList);
        ...
        for (int i = 0; i < webServicesHeadersList.size(); i++) {
    ...
    private void setFooterIcons() {
        ...
        textAnalyze.setTextColor(ContextCompat.getColor(ValuationListViewBarChartActivity.this,R.color.cobalt));
