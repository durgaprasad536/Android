...
public class SectorDetailsSubActivity extends AppCompatActivity {
    ...
    private int colorCode=R.color.tealish;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            colorCode = bundle.getInt(KEY_COLORCODE,R.color.tealish);
            toolbar.setBackgroundColor(ContextCompat.getColor(SectorDetailsSubActivity.this,colorCode));
            SectorDetailsSubActivity.this.setTitle(title);
        ...
        switch (position) {
            case 0:
                ...
                bundleFragment.putString(KEY_SECTOR_ID,Constants.trendingStocksBySectorID+sectorId);
            ...
            case 1:
                ...
                Fragment fragmentFunds = new StockHoldingsListFragment();
            ...
            case 2:
                ...
                bundleSector.putString(KEY_SECTOR_ID, Constants.sectorDetailsTopFiveSector);
                Fragment otherIdeas = new SectorFragment();
