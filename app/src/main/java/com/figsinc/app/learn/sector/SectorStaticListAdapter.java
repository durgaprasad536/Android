...
public class SectorStaticListAdapter extends RecyclerView.Adapter<SectorStaticListAdapter.MyViewHolder> {
    ...
    public SectorStaticListAdapter(List<String> sectorList, Context context,final String SectorID,final String keyword) {
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.linearParent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (position){
                    case 0:
                        Intent intent = new Intent(context, SectorDetailsSubActivity.class);
