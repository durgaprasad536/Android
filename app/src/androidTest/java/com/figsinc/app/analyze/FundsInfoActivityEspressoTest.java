...
public class FundsInfoActivityEspressoTest {

     @Rule
   public ActivityTestRule<FundsInfoActivity> stockInfoActivityActivityTestRule = new ActivityTestRule<FundsInfoActivity>(FundsInfoActivity.class);
    ...
    public void ValuationClick(){
        onData(hasToString(startsWith("Basic Info")))
    ...
    public void ProfitabilityClick(){
        onData(hasToString(startsWith("Management")))
                .inAdapterView(withId(R.id.filter1_recyclerView))
                .perform(click());
        pressBack();
    }
    ...
    public void EfficiencyClick(){
        onData(hasToString(startsWith("Yearly")))
                .inAdapterView(withId(R.id.filter1_recyclerView))
                .perform(click());
        pressBack();
    }
    ...
    public void capitalStructureClick(){
        onData(hasToString(startsWith("Lipper ScoreCard")))
                .inAdapterView(withId(R.id.filter1_recyclerView))
                .perform(click());
        pressBack();
    }
